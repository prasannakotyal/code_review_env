...
from server.environment import CODE_SNIPPETS
...
def load_config() -> InferenceConfig:
    ...
    task_name = TaskName(os.getenv("CODE_REVIEW_TASK", TaskName.STYLE_CHECK.value))
    ...
    return InferenceConfig(
        ...
        task_name=task_name,
        benchmark=os.getenv("CODE_REVIEW_BENCHMARK", "code_review"),
        max_steps=max_steps,
...
async def main() -> None:
    ...
    env = CodeReviewEnv(base_url=config.env_base_url)
